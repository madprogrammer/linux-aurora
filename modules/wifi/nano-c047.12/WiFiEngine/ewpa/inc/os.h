...
#ifndef isprint
#define isprint(c) ((char)(c) >= '!' && (char)(c) <= '~')
#endif

#define os_memcpy(d, s, n) DE_MEMCPY((d), (s), (n))
#define os_memmove(d, s, n) DE_MEMMOVE((d), (s), (n))
#define os_memset(s, c, n) DE_MEMSET((s), (c), (n))
#define os_memcmp(s1, s2, n) DE_MEMCMP((unsigned char *)(s1), (unsigned char *)(s2), (n))


#define os_malloc _nrx_os_malloc
#define os_free _nrx_os_free
#define os_realloc os_realloc
...
#define os_strlen(s)               DE_STRLEN((s))
#define os_strcasecmp(s1, s2)      strcasecmp((s1), (s2))
#define os_strncasecmp(s1, s2, n)  DE_STRNCASECMP((s1), (s2), (n))
#define os_strchr(s, c)            DE_STRCHR((s), (c))
#define os_strcmp(s1, s2)          DE_STRCMP((s1), (s2))
#define os_strncmp(s1, s2, n)      DE_STRNCMP((s1), (s2), (n))
#define os_strncpy(d, s, n)        DE_STRNCPY((d), (s), (n))
#define os_strrchr(s, c)           strrchr((s), (c))
#define os_strstr(h, n)            strstr((h), (n))
#define os_strcpy(d, s)            DE_STRCPY((d), (s))
